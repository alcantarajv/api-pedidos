...
- [Decisões técnicas](#decisões-técnicas)
  ...
  - [Idempotência](#idempotência-a-mesma-requisição-o-mesmo-efeito)
  - [Concorrência e consistência](#concorrência-e-consistência)
  - [Mensageria: outbox e consumidores](#mensageria-outbox-e-consumidores)
  - [Integração com o gateway](#integração-com-o-gateway-de-pagamento)
  - [Segurança](#segurança)
  - [Operação e observabilidade](#operação-expiração-limpeza-e-observabilidade)
...
Cada entrada registra a escolha, o motivo e a alternativa descartada. A seção foi alimentada etapa a etapa, não escrita no fim — são 84 decisões, agrupadas por tema.
